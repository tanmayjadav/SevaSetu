...
const router = createBrowserRouter(
  createRoutesFromElements(
    ...
    <Route path="/" element={<App />}>
      ...
      <Route path="/paymentsuccess/:Pid/:name/:email" element={<PaymentSuccess />} />
      <Route path="/paymentfail/:id" element={<PaymentFail />} />
      <Route path="/Aboutus" element={<AboutUs />} />
      <Route path="/explore" element={<Explore />} />
      <Route path="/" element={<Home />} />
      <Route path="/addpaymentdetail/:foundationId" element={<AddPaymentDetail />} />    
    </Route>
    <Route path="*" element={<NotFound />}/>
    <Route path="/foundation/register" element={<RegisterFoundation />} />
    <Route path="/foundation/login" element={<LoginFoundation />} />
    <Route path="/foundation/login/forgotpassword" element={<Forgotpassword />} />
    <Route path="/foundation/login/resetpassword/:token/:ex" element={<Resetpassword />} />
